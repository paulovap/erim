...
test_get_path_special_cases() ->
    testsuite:is(erim_xml:get_path(?ELEMENT1, []), ?ELEMENT1),
    try
        erim_xml:get_path(?ELEMENT1, [{attribute, "lang"} | bad_data]),
        testsuite:fail()
    catch
    ...
    try
        erim_xml:get_path(?ELEMENT1, [cdata | bad_data]),
        testsuite:fail()
    catch
        throw:{xml, path, ending_component_not_at_the_end,
          [cdata | bad_data]} ->
    ...
    try
        erim_xml:get_path(?ELEMENT1, bad_data),
        testsuite:fail()
    catch
...
test_get_path_element() ->
    testsuite:is(erim_xml:get_path(?ELEMENT1,
        [{element, "target"}]),
      undefined),
    testsuite:is(erim_xml:get_path(?ELEMENT2,
        [{element, "target"}]),
      ?TARGET),
    testsuite:is(erim_xml:get_path(?ELEMENT3,
        [{element, "target"}]),
      undefined),
    testsuite:is(erim_xml:get_path(?ELEMENT3,
